...
def evaluation(img_path, ckpt_path):
    ...
    for i in range(len(test_image)):
        ...
        pred = np.argmax(logits.eval(feed_dict={ 
            ...
            keep_prob: 1.0 })[0])
        return [result, pred, img_path]

if __name__ == '__main__':
    app.debug = True
    app.run()
    # print(evaluation('/Users/yuni/project/azureVM/takei_emi/face_only/0cd86e181ae871b79638096eeac34a04334fd67eb94334791b61c972cddd5602.jpg', '/Users/yuni/facetype_app/model.ckpt'))
